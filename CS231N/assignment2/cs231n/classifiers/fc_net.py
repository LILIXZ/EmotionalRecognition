...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in reversed(range(L-1)):
          ...
          if self.normalization == "batchnorm":
            dH, grads['gamma' + str(i+1)], grads['beta' + str(i+1)] = batchnorm_backward_alt(dH, norm_caches[i])
          if self.normalization == "layernorm":
            dH, grads['gamma' + str(i+1)], grads['beta' + str(i+1)] = layernorm_backward(dH, norm_caches[i])
