...
class EmotionModel(object):
    ...
    def __init__(
        ...
        # affine relu - 1
        hidden_dim = 256
        self.params['W3'] = weight_scale * np.random.randn(6400, hidden_dim)
        self.params['b3'] = np.zeros(hidden_dim)
        
        # affine relu - 2
        hidden_dim = 128
        self.params['W4'] = weight_scale * np.random.randn(256, hidden_dim)
        self.params['b4'] = np.zeros(hidden_dim)
        
        # output affine layer
        self.params['W5'] = weight_scale * np.random.randn(128, num_classes)
    ...
    def loss(self, X, y=None):
        ...
        W4, b4 = self.params["W3"], self.params["b3"]
        W5, b5 = self.params["W4"], self.params["b4"]
        W6, b6 = self.params["W5"], self.params["b5"]
        ...
        X3, fc_cache_2 = affine_relu_forward(X2, W5, b5)
        ...
        dout, grads['W5'], grads['b5'] = affine_backward(gradients, fc_cache_3)
        dout, grads['W4'], grads['b4'] = affine_relu_backward(dout, fc_cache_2)
        dout, grads['W3'], grads['b3'] = affine_relu_backward(dout, fc_cache)
        ...
        # L2 regulation
        grads['W5'] += self.reg * W6
        grads['W4'] += self.reg * W5
        grads['W3'] += self.reg * W4
